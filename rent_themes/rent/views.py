...
class RentViews:
    ...
    def saveRent(request):
        ...
        r = Rent(date=request.POST['date'],
             ...
             address=a)
        r.value = Util.CalcularDesconto(r, r.client_id, r.theme_id)  # fornecer um valor padrão caso a função retorne None
        r.save()  # salva o objeto Rent com o valor calculado
